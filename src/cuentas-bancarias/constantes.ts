...
export const formatoValido = /^(?<codigoPais>[A-Z]{2})(?<digitoControl>\d{2})(\s|-|_)?(?<codigoBanco>\d{4})(\s|-|_)?(?<codigoSucursal>\d{4})(\s|-|_)?(?<digitoControl2>\d{2})(\s|-|_)?(?<numeroCuenta>\d{10})$/;